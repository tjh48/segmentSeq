...
aD <- processTags(libfiles, dir = datadir, replicates, libnames, chrlens, chrs = c(">Chr1", ">Chr2"), header = TRUE)
aD
@ 
...
<<>>=
clustSegs <- clustSeg(sD = sD, aD = aD, cl = cl)
clustSegs
@ 
...
<<>>=
classSegs <- classifySeg(sD = sD, aD = aD, cD = clustSegs, subRegion = NULL, getLikes = TRUE, cl = cl)
classSegs
@ 
...
\bibitem{Hardcastle:2010a} Thomas J. Hardcastle and Krystyna A. Kelly. \textsl{Genome Segmentation From High-Throughput Sequencing Data.}. In preparation. 2010.
