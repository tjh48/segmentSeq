...
if(nrow(sD) != 215191) stop("sD object is the wrong size (should have 215191 rows). Failure.")
@ 
...
<<echo = FALSE, results = hide>>=
if(nrow(hS) != 4298) stop("hS object is the wrong size (should have 4298 rows). Failure.")
@ 
