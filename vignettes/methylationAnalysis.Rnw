...
if(nrow(sD) != 133101) stop("sD object is the wrong size (should have 133101 rows). Failure.")
@ 
...
<<echo = FALSE, results = hide>>=
if(nrow(hS) != 2638) stop("hS object is the wrong size (should have 2638 rows). Failure.")
@ 
